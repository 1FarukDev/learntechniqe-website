        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 mt-10 sm:mt-15">
          <div className="bg-[#E99E20] flex items-center justify-between rounded-lg p-4 sm:p-5 shadow-xl gap-4">
            <div className="flex flex-col gap-4 sm:gap-10 w-1/2 min-w-0">
              ...
              <Button asChild className="normal-case bg-[#01636B] w-full h-12 sm:h-16 text-sm sm:text-base px-2">
                <Link href="/courses/electrical">View electrical courses</Link>
              </Button>
            </div>
            <Image
              src={ElectricalIcon}
            ...
            <div className="flex flex-col gap-4 sm:gap-10 w-1/2 min-w-0">
              ...
              >
                <Link href="/courses/aircon-refrigeration">
                  View air-con and refrigeration courses
                </Link>
              </Button>
            </div>
            <Image
          ...
          <div className="bg-[#01636B] flex items-center justify-between rounded-lg p-4 sm:p-5 shadow-xl gap-4">
            <div className="flex flex-col gap-4 sm:gap-10 w-1/2 min-w-0">
              ...
              >
                <Link href="/courses/plc">View PLC training courses</Link>
              </Button>
            </div>
            <Image
              src={PLCIcon}
          ...
          <div className="bg-[#01636B] flex items-center justify-between rounded-lg p-4 sm:p-5 shadow-xl gap-4">
            <div className="flex flex-col gap-4 sm:gap-10 w-1/2 min-w-0">
              ...
              <Button
                ...
                className="normal-case bg-[#ECF0F0] text-black w-full h-12 sm:h-16 text-sm sm:text-base px-2"
              >
                <Link href="/courses/am2-assessment">View AM2 assessment</Link>
              </Button>
            </div>
            <Image
              src={AssessmentIcon}
