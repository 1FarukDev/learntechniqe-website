      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex gap-8 items-start mb-10">
          <div>
            ...
            <div className="max-w-4xl text-sm text-gray-800 leading-relaxed space-y-4 my-16">
              <p>
          ...
          <aside className="w-[200px] flex-shrink-0 flex flex-col gap-4">
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden">
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 bg-[#627080] text-sm font-semibold text-gray-800 hover:bg-[#627080]/90 transition"
              >
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-3xl font-bold text-black">More like this</h2>
            <div className="flex items-center gap-5">
              ...
              <Button className="bg-[#0D7377] hover:bg-[#0a5f63] text-white px-8 tracking-widest text-sm">
                SEE ALL BLOG POSTS
              </Button>
            </div>
          </div>
