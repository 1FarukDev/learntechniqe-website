...
function CourseHero() {
  return (
    <section className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 bg-linear-to-br from-[rgba(0,140,140,0.45)] via-[rgba(0,100,110,0.65)] to-[rgba(0,60,80,0.85)]" />

      <div className="relative z-20 max-w-7xl mx-auto px-6 py-35 flex flex-col lg:flex-row items-start gap-12">
        <div className="w-full lg:w-[50%] text-white">
          ...
          <h1 className="font-outfit font-semibold text-4xl md:text-5xl leading-tight mb-6">
            Total Industrial Electrical <br /> Maintenance 10
          </h1>

          <div className="space-y-2 text-white text-base leading-7">
            <p>
          ...
          <a
            href="#"
            className="inline-block mt-8 text-[#4DD9AC] font-semibold text-sm underline underline-offset-4 hover:text-white transition-colors"
          >
            Request Course Overview
          </a>
        </div>

        <div className="w-full lg:w-[40%] p-8 flex flex-col gap-5 bg-white rounded-2xl border-[#016068] overflow-hidden">
          <div>
            <p className="text-[#14AE5C] font-outfit font-bold text-5xl">
              £1,450
            </p>
          </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-[#016068] font-outfit font-bold text-base">
              ...
              {[
                ...
                >
                  ...
                  <div className="shrink-0 border border-gray-200 rounded-md px-3 py-2 flex items-center gap-1.5 text-xs text-gray-400">
                    <span className="">Accredited by</span>
                    <Image
                      src={CityGuildsLogo}
          ...
          <div className="grid grid-cols-2 gap-5">
            <Button className="bg-[#F5A623] hover:bg-[#e09410] text-white font-outfit font-semibold uppercase tracking-widest text-sm h-14">
              Book Now
            </Button>
            <Button className="bg-[#016068] hover:bg-[#014d54] text-white font-outfit font-semibold uppercase tracking-widest text-sm h-14">
              Contact Us
            </Button>
          </div>
        </div>
