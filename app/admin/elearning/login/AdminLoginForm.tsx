...
export function AdminLoginForm() {
  ...
  const nextPath = searchParams.get("next") || "/admin/elearning";
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null);
    try {
      const res = await fetch("/api/admin/elearning/login", {
        method: "POST",
      ...
      router.replace(nextPath.startsWith("/admin") ? nextPath : "/admin/elearning");
      router.refresh();
    } catch {
